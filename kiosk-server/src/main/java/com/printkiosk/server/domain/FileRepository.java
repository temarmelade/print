...
public interface FileRepository extends JpaRepository<FileEntity, UUID> {
    ...
    /**
     * Продлевает жизнь файла, у которого оплачено задание одного из
     * указанных типов: цифровая доставка скана или печать. Только продлевает
     * (не укорачивает) и только живой, не израсходованный файл.
     */
